...
const TransactionTable = ({onViewDetails, transactions}: TCategoryTableProps) => {
            ...
            >
              ...
              <td className="px-6 py-7.5 flex items-center gap-3 text-gray-600">
                <button
                  ...
                  className="flex gap-2 cursor-pointer hover:bg-gray-100 w-fit py-1 px-2 rounded-md items-center"
                >
                  <FiEye size={18} />
                  View Details
                </button>
