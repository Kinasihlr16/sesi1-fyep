...
const LoginPage = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      setErrorMessage(err.errorMessage || "Something went wrong, please try again later.")
    ...
    return (
      <main className="bg-[#F7F9FA] w-full min-h-screen flex justify-center items-center">
        <div className="max-w-136 w-full bg-white rounded-xl border-t-4 border-primary py-12 px-[72px]">
          ...
          <div className="px-3 py-1 bg-primary-light borber border-primary rounded-md text-primary text-center text-sm w-full mb-2 ">
            {errorMessage}
          </div>
