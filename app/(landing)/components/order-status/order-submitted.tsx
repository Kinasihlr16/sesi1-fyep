...
const OrderSubmitted = () => {
    ...
    return (
      <div className="bg-white w-160.25 p-16 flex flex-col items-center justify-center mx-auto">
        <Image
          ...
          className="mb-4"
        />
        <h2 className="text-center mb-2 text-2xl font-semibold">Order Submitted!</h2>
