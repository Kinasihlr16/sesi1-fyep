...
const BankInfoModal = ({ isOpen, onClose, onSuccess }: TCategoryModalProps) => {
      ...
      const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
          ...
          console.error(isEditMode ? "Failed to update bank" : "Failed to create bank info", error);
          toast.error(isEditMode ? "Failed to update bank" : "Failed to create bank info");
        } finally {
