...
const ImageUploadPreview = ({label, value, onChange, className}: TImageUploadPreviewProps) => {
    ...
    return (
        <div className={className}>
            ...
            {
                value ? (
                    <Image src={value} alt="preview product" className="w-full h-full object-cover" width={290} height={190}></Image>
                ): (<>
                <FiUploadCloud className="text-primary" size={24}></FiUploadCloud>
